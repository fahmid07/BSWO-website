...
<body class="home">
		...
		<div class="container py-5 mb-2">
			<div class="row">
				<div class="col-lg-6 mb-2">
					...
					<br>
					<a href="about.html" class="btn btn-success">Click to know more</a>
				</div>
				<div class="col-lg-6 mb-2">
					<div class="card">
	...
	<div class="row justify-content-center bg-light">
		<div class="col-auto" >
			<a allign="center" href="#" class="btn btn-success" style="width:400px; height: 40px;">Click to know more</a>
		</div>
	</div>
	...
	<div class="row justify-content-center">
		<div class="col-auto" >
			<a allign="center" href="microfinance.html" class="btn btn-success" style="width:400px; height: 40px;">Click to know more</a>
		</div>
	</div>
	...
	<div class="container-fluid bg-light mt-5">
		<div class="row">
			<div class="col-sm-5 text-white" style="background-image: url(images/members.jpg); padding: 4rem;">
				...
				<br>
				<a href="others.html" class="btn btn-success">Click to know more</a>
			</div>
			<div class="col-sm-7 p-5">
				...
				<div class="row justify-content-center text-center mt-5" style="font-size: 20px;">
					...
					<div class="card bg-light"
						style="width: 15rem; height: 15rem; border-radius: 50%; border-width: 5px; border-color: #990000;">
						<div class="card-body fw-bold">
							<br>
							<br>
				...
				<div class="row justify-content-center mt-5">
					<a href="microfinance.html.#glance" class="btn btn-success" style="width: 25%;">Click to know more</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container-fluid me-lg-5 px-lg-5">
			...
			<div class="row px-lg-5">
				...
				<div class="col-md-5 col-lg-5 col-xl-5 mx-auto mt-3" style="padding: 0rem 4rem;">
					...
					<br>
					<p>
						<a href="about.html" class="text-white" style="text-decoration: none;">Click to learn more >></a>
					</p>
