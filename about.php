...
<body class="home">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 py-5">
					...
					<p class="fs-5 pt-4 pointer" onclick="district()"> <i class="fa fa-angle-double-right"
							style="color:#02b321"></i> District: 1</p>
					...
					<p class="fs-5 pt-4 pointer" onclick="thana()"> <i class="fa fa-angle-double-right"
							style="color:#02b321"></i> Thana: 7</p>
					...
					<p class="fs-5 pt-4 pointer" onclick="ward()"> <i class="fa fa-angle-double-right"
							style="color:#02b321"></i> Ward: 17</p>
					...
					<p class="fs-5 pt-4 pointer" onclick="union()"> <i class="fa fa-angle-double-right"
							style="color:#02b321"></i> Union: 1</p>
	...
	<div class="row justify-content-center text-center">
		...
		<hr allign="center"
			style="height:6px; width:15%; background-color:#990000; margin-top: 10px; margin-bottom:50px;">
	</div>
